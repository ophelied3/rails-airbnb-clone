...
avatar_url = ["https://images.pexels.com/photos/257573/pexels-photo-257573.jpeg?w=1260&h=750&auto=compress&cs=tinysrgb", "https://images.pexels.com/photos/209065/pexels-photo-209065.jpeg?w=1260&h=750&auto=compress&cs=tinysrgb","https://static.pexels.com/photos/161461/horse-brown-mold-thoroughbred-arabian-foal-161461.jpeg?w=1260&h=750&auto=compress&cs=tinysrgb", "https://images.pexels.com/photos/236651/pexels-photo-236651.jpeg?w=1260&h=750&auto=compress&cs=tinysrgb", "https://images.pexels.com/photos/236651/pexels-photo-236651.jpeg?w=1260&h=750&auto=compress&cs=tinysrgb", "https://images.pexels.com/photos/297201/pexels-photo-297201.jpeg?w=1260&h=750&auto=compress&cs=tinysrgb", "https://images.pexels.com/photos/370179/pexels-photo-370179.jpeg?w=1260&h=750&auto=compress&cs=tinysrgb", "https://images.pexels.com/photos/463735/pexels-photo-463735.jpeg?w=1260&h=750&auto=compress&cs=tinysrgb" ]


puts "Génération des chevaux"
for i in (0..7) do
  Horse.new(name:name[i], address: address[i], description: description[i], title: title[i], birth_date: birth_date[i], sexe: sexe.sample, race: race.sample, disciplines: disciplines.sample, character: character.sample, required_level: rand(0..9), monthly_price: rand(50..300), user_id: user1.id, avatar_url: avatar_url[i]).save!
